...
const Leaderboard = () => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4 lg:p-8 text-lg mt-8 max-w-2xl w-full flex-1">
      ...
      <div className="bg-white w-full overflow-x-auto rounded-md py-4">
      ...
      <table className="table-auto text-left w-full overflow-x-scroll scroll-smooth whitespace-nowrap">
        ...
        <tbody className="">
          <tr className="">
            <td className="pr-2">paula.suarez@con...es</td>
            <td className="px-2">6500</td>
            <td className="px-2">USA</td>
          </tr>
          <tr className="">
            <td className="pr-2 truncate">laura.kenet...3@yahoo.com</td>
            <td className="px-2">2300</td>
            <td className="px-2">Monaco</td>
          </tr>
          <tr className="">
            <td className="pr-2">aaron.micahel@arg.org</td>
            <td className="px-2">1200</td>
            <td className="px-2">Prague</td>
          </tr>
          <tr className="">
            <td className="pr-2">jeremy.runner@aol.com</td>
